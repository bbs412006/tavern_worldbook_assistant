...
checks = {
    ...
    'settings modal shields host pointer events': settings.count('shieldModalHostEvent') >= 4 and '@click.self=' in settings,
    'ai config modal shields host pointer events': ai.count('shieldModalHostEvent') >= 10 and ai.count('@click.self=') >= 2,
    ...
    'settings modal uses modal host shielding': "from '../host/modalHost'" in settings and 'shieldModalHostEvent' in settings,
    'ai config modal uses modal host shielding': "from '../host/modalHost'" in ai and 'shieldModalHostEvent' in ai,
