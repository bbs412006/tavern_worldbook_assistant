  ...
  <section class="cross-copy-panel desktop">
    <div class="cross-copy-head">
      ...
      <div class="cross-copy-head-actions">
        ...
        <button class="btn mini utility-btn" type="button" @click="$emit('toggle-controls-collapsed')">
          {{ controlsCollapsed ? '展开高级项' : '收起高级项' }}
        </button>
        <button class="btn mini utility-btn" type="button" :disabled="cineLocked" @click="$emit('exit')">退出模式</button>
