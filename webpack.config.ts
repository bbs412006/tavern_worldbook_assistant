    ...
    plugins: (entry.html === undefined
      ...
      .concat(
        ...
        new webpack.DefinePlugin({
          ...
          __WB_ASSISTANT_BUILD_BRANCH__: JSON.stringify(
            process.env.WB_BUILD_BRANCH ?? (process.env.CI === 'true' ? 'ST-Manager-STscript' : read_git_value('git rev-parse --abbrev-ref HEAD', 'unknown')),
          ),
